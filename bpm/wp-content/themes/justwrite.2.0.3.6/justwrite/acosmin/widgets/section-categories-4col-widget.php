...
/* ------------------------------------------------------------------------- *
 *
 *  Categories (4 Columns) Section/Widget
 *  ________________
 *
 *	Adds a row displaying posts from categories (four columns)
 *	________________
 *
/* ------------------------------------------------------------------------- */
...
if( ! class_exists( 'AC_Section_Cat_4_Columns' ) ) {
	class AC_Section_Cat_4_Columns extends AC_Section {
		...
		function widget( $args, $instance ) {
			...
			$section_category4	= ! empty( $instance['category_4'] ) ? $instance['category_4'] : ''; set_query_var( 'section_category4', absint( $section_category4 ) );
		...
		function form( $instance ){
			...
			?>
                ...
                <p>
                    <label for="<?php echo $this->get_field_id( 'category_4' ); ?>"><?php esc_html_e( '4th column category', 'justwrite' ); ?></label>
                    <?php
